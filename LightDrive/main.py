...
class LightDrive:
    def __init__(self, default_workspace: str):
        ...
        engine.rootContext().setContextProperty("snippetHandler", self.snippet_handler)
        ...
        engine.rootContext().setContextProperty("fixtureBlueprintModel", self.data_models.fixture_blueprint_model)
