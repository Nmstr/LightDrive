    ...
    def open_workspace(self, workspace_file_path: str) -> None:
        ...
        for snippet in snippets:
            match snippet["type"]:
                ...
                case "two_d_efx":
                    efx_2d_data = TwoDEfxData(snippet["uuid"], snippet["name"], snippet.get("pattern", "Circle"), snippet.get("width", 512), snippet.get("height", 512), snippet.get("x_offset", 0), snippet.get("y_offset", 0), snippet.get("fixture_mappings", {}), snippet.get("duration", 5000))
